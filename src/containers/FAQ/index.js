  ...
  render() {
    return (
      <div className={styles}>
        ...
        <p>1. FIM itu apa?<br />Gerakan Kaderisasi Kepemudaan, yang mencita-citakan Indonesia yang lebih baik: mandiri, berdaulat, adil dan makmur.<br />Berdiri sejak 2003 dengan model forum aktivis yang menyelenggarakan pelatihan kepemimpinan dan karakter. Sejak 2017, kami berupaya fokus pada apa yang menjadi ciri dan kekuatan utama jaringan FIM selama ini, yaitu kaderisasi kepemudaan.<br /> <br />2. FIM Regional itu apa?<br />Setelah 5 tahun gerakan FIM, FIM mulai membangun model gerakan yang berbasis regional agar visi pemberdayaan dimulai tidak hanya dari Jakarta. Sejak 2017, para penggerak regional disebut kader next gen. Program regional berbasis pada aktivitas pemberdayaan masyarakat di daerah masing-masing.</p>
        <p>3. Kader Next Gen itu siapa, tugasnya apa?<br />Pemuda/i berusia 18-25 tahun, yang siap minimal selama 1 tahun kedepan fokus membangun aktivitas di FIM regional masing-masing. Para kader next gen, akan diberikan pelatihan dan penguatan nilai-nilai FIM pada pelatihan wilayah yang tersebar di 5 daerah di Indonesia selama 3-4 hari, pada rentang bulan Juni-Juli 2018.</p>
        <p>4. Apa itu pelatihan wilayah?<br />Aktivitas yang bertujuan untuk meningkatkan kapasitas dan persiapan kader next gen mulai dari softskill, internalisasi nilai-nilai FIM dan perumusan kegiatan regional.</p>
        <p>5. Model pelatihan wilayahnya seperti apa?<br />Bootcamp training (pelatihan intensif) selama 3-4 hari di akhir pekan, yang akan diikuti oleh 100-150 peserta dari regional di sekitar lokasi pelatihan</p>
        <p>6. Regional mana saja yang membuka pendaftaran kader next gen untuk diikutkan ke pelatihan wilayah FIM ?</p>
