		...
		<div >
			{this.renderPreviewPictures()}
				...
				<div key="0" className="uploadPictureContainer container-bottom">
					...
					<img style={{ maxWidth: '200px', maxHeight: '200px' }} src={this.props.valueImage} className="uploadPicture" alt="preview"/>
				</div>
			)
		}
...
ImageUploader.defaultProps = {
	                    ...
	                    labelStyles: {},
	                    labelClass: '',
	                    imgExtension: ['.jpg', '.gif', '.png', '.jpeg', '.JPG', '.JPEG', '.PNG', '.GIF'],
	                    maxFileSize: 5242880,
