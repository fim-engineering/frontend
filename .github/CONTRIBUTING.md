# Contributing to JimJam boilerplate

Love JimJam boilerplate and want to help? Thanks so much, there's something to do for everybody!
...
The [issue tracker](https://github.com/hackingbeauty/jimjam/issues) is
...
1. [Fork](https://help.github.com/articles/fork-a-repo/) the project, clone your fork, and configure the remotes:
   ...
   git clone https://github.com/<your-username>/jimjam.git
   # Navigate to the newly cloned directory
   cd jimjam
   # Assign the original repo to a remote called "upstream"
   git remote add upstream https://github.com/hackingbeauty/jimjam.git
   ```
...
owners to license your work under the terms of the [MIT License](https://github.com/hackingbeauty/jimjam/blob/master/LICENSE.md).